...
<%@ page import="java.util.*, da.CustomerDA, da.PurchaseDA, domain.Customer, domain.Purchase" %>
<jsp:include page="header.jsp"/>

<%
  CustomerDA customerDA = new CustomerDA();
  PurchaseDA purchaseDA = new PurchaseDA(); 
  List<Customer> customers = customerDA.getAllCustomer();
%>


<%
    String role = "Manager"; // Replace with session.getAttribute("role") later if dynamic role
...
<body>
    <div class="main-content">
       ...
       <table>
  <tr>
    <th>ID</th><th>Name</th><th>Phone</th><th>Email</th><th>Purchase History</th>
  </tr>
